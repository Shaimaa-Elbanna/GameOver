...
export default function All() {
  let { loadMore, inishialLoad, isComplate, loading } = useContext(AllmovieContext)
      ...
      {loading ?
        <section className='All '>
          <div className="container my-3">
            ...
            {isComplate ?
              <button className="btn btn-outline-info col-md-3 bg-danger my-4" onClick={loadMore}> that's it</button>

              :
              <button className="btn btn-outline-info col-md-3 my-4 " onClick={loadMore}> See More</button>
            }
